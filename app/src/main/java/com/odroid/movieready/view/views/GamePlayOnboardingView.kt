...
fun PreviewGamePlayOnboardingView() {
    GamePlayOnboardingView(true, onStartClick = {})
}

@Composable
fun GamePlayOnboardingView(isStartGameEnabled: Boolean, onStartClick: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        if(isStartGameEnabled) {
            ...
            CircularProgressIndicator(color = IshaaraColors.app_button_background_primary)
        }
